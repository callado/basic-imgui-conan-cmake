...
//  2021-12-15: OpenGL: Using buffer orphaning + glBufferSubData(), seems to fix
//  leaks with multi-viewports with some Intel HD drivers. 2021-08-23: OpenGL:
//  Fixed ES 3.0 shader ("#version 300 es") use normal precision floats to avoid
//  wobbly rendering at HD resolutions. 2021-08-19: OpenGL: Embed and use our
//  own minimal GL loader (imgui_impl_opengl3_loader.h), removing requirement
//  and support for third-party loader. 2021-06-29: Reorganized backend to pull
